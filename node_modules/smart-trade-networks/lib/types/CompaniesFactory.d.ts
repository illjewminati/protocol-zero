...
interface CompaniesFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class CompaniesFactory extends Contract {
  ...
  interface: CompaniesFactoryInterface;
